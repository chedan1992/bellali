    ...
    <script language="javascript" type="text/javascript">
        ...
        Ext.onReady(function () {
            ...
            function CreateTemple(Num) {
                ...
                { ID: 2, Name: '小图', mark: '150*150高度可变', large: '150*150', TemplePic: '../../Resource/img/templePic/2.jpg', limit: 1, top: 50 }, ];
                ...
                items: [
                 {
                     ...
                     items: [
                         ...
                         items: [
                                ...
                                },
                                {
                                ...
                                },
                                 {
                                    ...
                                    {
                                             xtype: 'compositefield',
                                             fieldLabel: '<span class="required">*</span>设置栏目',
                                             combineErrors: false,
                                             anchor: '100%',
                                             items: [
                                                 //{
                                                 ...
                                                 //{
                                                 //    xtype: 'tbtext',
                                                 //    text: '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="required">*</span>设置栏目',
                                 ...
                                 {
                                 xtype: 'radiogroup',
                                 fieldLabel: '<span class="required">*</span>文章类型',
                                 id: 'ActionType',
                                 allowBlank: false,
                                 width: 220,
                                 items: [
						                { boxLabel: '内部文章', name: 'ActionType', id: 'ActionType1', inputValue: 1, checked: true },
                                        { boxLabel: '外部文章', name: 'ActionType', id: 'ActionType2', inputValue: 2 }
                                    ],
                                 listeners: {
                                     'change': function (checked) {
                                         ChangeActionType();
                         ...
                         anchor: '80%'
                                 ...
                                 {
                         fieldLabel: '<span class="required">*</span>内容',
                         xtype: 'textarea',
                         id: 'Content',
                         name: 'Content',
                         allowBlank: true,
                 ...
                 new Ext.form.Checkbox({
                          ...
                          },
                    {
                        ...
                        items: [
                            ...
                            {
                                xtype: 'panel',
                                fieldLabel: '<span class="required">*</span>标示图',
                                id: 'composCombin',
                                border: false,
                                layout: 'form',
                                items: [
        ...
        function initVisible() {
            ...
            if (Id) {//编辑
                ...
                if (result) {
                    ...
                    Ext.getCmp("ActionType").setValue(result.ActionType); //文章类型
        ...
        function SaveDate() {
            ...
            if (formPanel.getForm().isValid()) {//如果验证通过
                ...
                if (ShowType == 2) {
                    ...
                    para = { ActiveStartTime: sbeginDate, ActiveEndTime: sendDate, Template: Template, IsTop: IsTop, AdModel: Ext.encode(Content) };
                }
                else {
                    para = {Template: Template, IsTop: IsTop, AdModel: Ext.encode(Content) }
                }
