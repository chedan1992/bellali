...
Ext.onReady(function () {
    ...
    */
    ...
    var treeloader = new Ext.tree.TreeLoader({
        url: "/Organizational/SearchRolesData"
    });
    ...
    var tree = new Ext.tree.TreePanel({
        ...
        loader: new Ext.tree.TreeLoader({
            dataUrl: '/Organizational/SearchRolesData'
        }),
        root: {
            nodeType: 'async',
            text: '组织架构',
    ...
    //数据源
    var store = GridStore(Member, '/SysAppointed/SuperParentData', className);
...
//        },
    ...
    grid.store.on('beforeload', function (node) {
        grid.getStore().proxy.conn.url = '/SysAppointed/SuperParentData?Id=' + treeNodeId;
    });
