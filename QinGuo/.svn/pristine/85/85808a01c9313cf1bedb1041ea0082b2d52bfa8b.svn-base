        ...
        Ext.onReady(function () {
            ...
            var form = new Ext.FormPanel({
                ...
                items: [
                     ...
                     {
                         name: 'ActiveName',
                         fieldLabel: '<span class="required">*</span>幻灯片标题',
                         xtype: 'textfield',
                         id: 'ActiveName',
                         maxLength: 50,
                         allowBlank: false,
                      ...
                      },
                     {
                         ...
                         items: [
                                ...
                                },
                                {
                                 ...
                                 {
                                     xtype: 'compositefield',
                                     fieldLabel: '<span class="required">*</span>幻灯片图',
                     ...
                     {
                         xtype: 'radiogroup',
                         fieldLabel: '<span class="required">*</span>幻灯片类型',
                         id: 'ActionType',
                         allowBlank: false,
                         width: 220,
                         items: [
						        { boxLabel: '内部文章', name: 'ActionType', id: 'ActionType1', inputValue: 1, checked: true },
                                { boxLabel: '外部链接', name: 'ActionType', id: 'ActionType2', inputValue: 2 },
                                { boxLabel: '系统文章', name: 'ActionType', id: 'ActionType3', inputValue: 3 }
                            ],
                         listeners: {
                             'change': function (checked) {
                                 ChangeActionType();
        ...
        function initVisible() {
            ...
            if (Id) {//编辑
                ...
                if (result) {
                    ...
                    Ext.getCmp("ActionType").setValue(result.ActionType); //幻灯片类型
