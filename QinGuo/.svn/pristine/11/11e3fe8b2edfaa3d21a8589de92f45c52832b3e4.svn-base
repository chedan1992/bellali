...
Ext.onReady(function () {
    ...
    var store = GridStore(ETask, '/Flow/SearchWaitWorkData');
        ...
        columns: [
            new Ext.grid.RowNumberer({ header: '', width: 25 }), //设置行号
             ...
             renderer: function (value, meta, record, rowIdx, colIdx, store) {
                 var content = '<a href="#" style="vertical-align: middle;cursor:pointer" onclick="DoWork()"><img style="vertical-align: middle; width:18px; height:18px;border:0" class="GTP_open"  src="../../Content/Extjs/resources/images/default/s.gif"/>办理</a>';
                 return content;
             }
         },
            {
