                ...
                var n, o = this,
                    ...
                    u = function () {
                        ...
                        layui.each(a, function (e, a) {
                            l.data = l.datas[e];
                            var r = new FormData;
                            layui.each(l.data, function (e, t) { t = "function" == typeof t ? t() : t, r.append(e, t) }),
                                r.append(l.field, a),
                                i.ajax({
                                    url: l.url,
                                    type: "post",
                    ...
                    y = function () {
                        l.datas = {};
                        var jj = 0;
                        for (var key in o.chooseFiles) {
                            var t={};
                            //上传loading
                            var othis = l;
                            t.key = "UploadFiles/Img/" + o.chooseFiles[key].name;
                            t.name = o.chooseFiles[key].name;
                            othis.datas[key] = t;
                            jj++;
                            if (jj == o.fileLength) {
