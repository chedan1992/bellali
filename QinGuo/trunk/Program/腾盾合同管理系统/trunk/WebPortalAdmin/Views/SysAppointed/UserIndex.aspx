...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <!--数据导出-->
    <form method="post" action="#" class="hide hideform">
    </form>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="UrlContent" runat="server">
    ...
    <script src="<%=Url.Content("~/Project/SysAppointed/SysAppointed.js?version=1.5") %>"
        type="text/javascript"></script>
    <script src="<%=Url.Content("~/Project/SysAppointed/UserIndexLayout.js?version=1.5") %>"
        type="text/javascript"></script>
    <style type="text/css">
       .x-grid-record-red {  
