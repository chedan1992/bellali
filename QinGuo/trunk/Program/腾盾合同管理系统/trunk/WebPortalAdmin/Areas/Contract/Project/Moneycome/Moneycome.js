...
function ImportDate() {
    //下载地址
    var downMoBanUlr = "/Project/Template/支出经费模板.xlsx";
            ...
            if (index == 2) {
                ...
                if (formPanel.getForm().isValid()) {//如果验证通过
                    ...
                    formPanel.getForm().submit({
                        ...
                        method: "POST",
                        url: '/Contract/InCome/ImportDate?CType=2',
                        //params: para,
    ...
    if (grid.store.data.length > 0) {
        var confirm = top.Ext.MessageBox.confirm('系统确认', '您确定要导出当前列表信息吗?', function (e) {
            if (e == "yes") {
                ...
                var url = '/Contract/InCome/ImportOut?CType=2' + aa + '&date=' + new Date();
...
function DeleteDate() {
    ...
    var rows = grid.getSelectionModel().getSelections();
    if (rows.length == 1) {
        var confirm = top.Ext.MessageBox.confirm('系统确认', '删除经费,相关信息一并删除.确认要删除该经费信息吗?', function (e) {
            if (e == "yes") {
                var ids = [];
...
function AddDate() {
    ...
    //        parent.AddTabPanel('新增收入经费', 'AddInCome', tabId, '/Contract/InCome/IncomeEdit?CType=1');
    //    }
    var window = CreateFromWindow("新增支出经费", "");
    var form = top.Ext.getCmp('formPanel');
    form.form.reset();
    url = '/Contract/InCome/SaveData?CType=3';
    window.show();
}
//编辑
function EditDate() {
                   ...
                   items: [
                     {
                         ...
                         layout: "form", // 从上往下的布局
                         items: [
                             { fieldLabel: '经费编号', xtype: 'textfield', id: 'NumCode', name: 'NumCode', maxLength: 50,
                                 emptyText: '请输入经费编号', maxLengthText: '经费编号长度不能超过50个字符', anchor: '90%'
                             }]
                     },
                       {
                           columnWidth: .25, // 该列有整行中所占百分比
                           ...
                           layout: "form", // 从上往下的布局
                           items: [
                                { fieldLabel: '原经费编号', xtype: 'textfield', id: 'OldNumCode', name: 'OldNumCode', maxLength: 50,
                                    maxLengthText: '原经费编号长度不能超过50个字符', anchor: '90%'
                                }]
                       },
                         {
                             columnWidth: .25, // 该列有整行中所占百分比
                             ...
                             layout: "form", // 从上往下的布局
                             items: [
                                 { fieldLabel: '<span class="required">*</span>经费名称', xtype: 'textfield', id: 'ContraceName', name: 'ContraceName', maxLength: 50,
                                     allowBlank: false, maxLengthText: '经费名称长度不能超过50个字符', anchor: '90%'
                                 }
                         ]
                         },

                           {
                               ...
                               layout: "form", // 从上往下的布局
                               items: [
                                { fieldLabel: '经费性质', xtype: 'textfield', id: 'Nature', name: 'Nature', maxLength: 50,
                                    maxLengthText: '经费性质长度不能超过50个字符', anchor: '90%'
                                }
                             ]
                           }
                     ]
                   ...
                   items: [
                     {
                         ...
                         items: [

                            {
                                ...
                                fieldLabel: '<span class="required">*</span>经费状态',
                                emptyText: '==选择==',
                                forceSelection: true,
                                editable: true,
                                typeAhead: true, //模糊查询
                     ...
                     },
                       {
                       ...
                       },
                         {
                         ...
                         },
                           {
                               ...
                               layout: "form", // 从上往下的布局
                               items: [
                                   { fieldLabel: '经费执行情况', xtype: 'textfield', id: 'ContractIimplementation', name: 'ContractIimplementation', maxLength: 50,
                                       emptyText: '', maxLengthText: '经费执行情况长度不能超过50个字符', anchor: '90%'
                                   }
                             ]
                           }
                     ]
                   ...
                   items: [
                     {
                         ...
                         layout: "form", // 从上往下的布局
                         items: [
                             { fieldLabel: '经费金额币种', xtype: 'textfield', id: 'Currency', name: 'Currency', maxLength: 50,
                                 emptyText: '', maxLengthText: '经费金额币种长度不能超过50个字符', anchor: '90%'
                             }]
                     },
                       {
                           columnWidth: .25, // 该列有整行中所占百分比
                   ...
                   items: [
                     {
                         ...
                         layout: "form", // 从上往下的布局
                         items: [
                            { fieldLabel: '计划付款金额', xtype: 'numberfield', id: 'InvoiceValueHas', name: 'InvoiceValueHas', maxLength: 50,
                   ...
                   items: [
                     {
                         ...
                         layout: "form", // 从上往下的布局
                         items: [
                         //                             { fieldLabel: '计划付款总额', xtype: 'numberfield', id: 'PlanTotalAmount', name: 'PlanTotalAmount', maxLength: 50,
                         //                                 emptyText: '', anchor: '90%', minValue: 0, maxValue: 999999999
                         //                             }
                             ]
                     },
                       {
                           ...
                           layout: "form", // 从上往下的布局
                           items: [
                               { fieldLabel: '经费总金额', xtype: 'numberfield', id: 'TotalContractAmount', name: 'TotalContractAmount', maxLength: 50,
                       ...
                       },
                         {
                             ...
                             layout: "form", // 从上往下的布局
                             items: [
                                  { fieldLabel: '财务支付总额', xtype: 'textfield', id: 'ReceiptsTotalAmount', name: 'ReceiptsTotalAmount', maxLength: 50,
                         ...
                         },
                           {
                               ...
                               layout: "form", // 从上往下的布局
                               items: [
                                    { fieldLabel: '待付金额', xtype: 'numberfield', id: 'ReceivablesAmount', name: 'ReceivablesAmount', maxLength: 50,
                                        emptyText: '', anchor: '90%', minValue: 0, maxValue: 999999999, readOnly: true
                                    }
                             ]
                           }
                                 ...
                                 items: [
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'AgreedTime1', name: 'AgreedTime1',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '付款时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'AgreedMoney1', name: 'AgreedMoney1', maxLength: 50,
                                                        emptyText: '付款金额', width: 90, minValue: 0, maxValue: 999999999
                                                    }
                                            ]
                                        },
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'AgreedTime2', name: 'AgreedTime2',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '付款时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'AgreedMoney2', name: 'AgreedMoney2', maxLength: 50,
                                        ...
                                        },
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'AgreedTime3', name: 'AgreedTime3',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '付款时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'AgreedMoney3', name: 'AgreedMoney3', maxLength: 50,
                                                        emptyText: '', width: 90, minValue: 0, maxValue: 999999999
                                                    }
                                            ]
                                        },
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'AgreedTime4', name: 'AgreedTime4',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '付款时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'AgreedMoney4', name: 'AgreedMoney4', maxLength: 50,
                                                        emptyText: '', width: 90, minValue: 0, maxValue: 999999999
                                                    }
                                            ]
                                        },
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'AgreedTime5', name: 'AgreedTime5',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '付款时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'AgreedMoney5', name: 'AgreedMoney5', maxLength: 50,
                                                        emptyText: '', width: 90, minValue: 0, maxValue: 999999999
                                                    }
                                            ]
                                        }
                                   ...
                                   items: [
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'FinancialTime1', name: 'FinancialTime1',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '付款时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'FinancialAmount1', name: 'FinancialAmount1', maxLength: 50,
                                        ...
                                        },
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'FinancialTime2', name: 'FinancialTime2',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '付款时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'FinancialAmount2', name: 'FinancialAmount2', maxLength: 50,
                                                        emptyText: '', width: 90, minValue: 0, maxValue: 999999999, enableKeyEvents: true, listeners: {
                                                            'keyup': function (e) {
                                                                TotalReceiptsTotalAmount();
                                                            }
                                        ...
                                        },
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'FinancialTime3', name: 'FinancialTime3',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '付款时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'FinancialAmount3', name: 'FinancialAmount3', maxLength: 50,
                                                        emptyText: '', width: 90, minValue: 0, maxValue: 999999999, enableKeyEvents: true, listeners: {
                                                            'keyup': function (e) {
                                                                TotalReceiptsTotalAmount();
                                                            }
                                        ...
                                        },
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'FinancialTime4', name: 'FinancialTime4',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '付款时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'FinancialAmount4', name: 'FinancialAmount4', maxLength: 50,
                                                        emptyText: '', width: 90, minValue: 0, maxValue: 999999999, enableKeyEvents: true, listeners: {
                                                            'keyup': function (e) {
                                                                TotalReceiptsTotalAmount();
                                                            }
                                        ...
                                        },
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'FinancialTime5', name: 'FinancialTime5',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '付款时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'FinancialAmount5', name: 'FinancialAmount5', maxLength: 50,
                                                        emptyText: '', width: 90, minValue: 0, maxValue: 999999999, enableKeyEvents: true, listeners: {
                                                            'keyup': function (e) {
                                                                TotalReceiptsTotalAmount();
                                                            }
                                   ...
                                   items: [
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'TicketTime1', name: 'TicketTime1',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '开票时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'TicketMoney1', name: 'TicketMoney1', maxLength: 50,
                                                        emptyText: '', width: 90, minValue: 0, maxValue: 999999999, enableKeyEvents: true, listeners: {
                                                            'keyup': function (e) {
                                        ...
                                        },
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'TicketTime2', name: 'TicketTime2',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '开票时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'TicketMoney2', name: 'TicketMoney2', maxLength: 50,
                                                        emptyText: '', width: 90, minValue: 0, maxValue: 999999999, enableKeyEvents: true, listeners: {
                                                            'keyup': function (e) {
                                                                TotalInvoiceValueHas();
                                                            }
                                        ...
                                        },
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'TicketTime3', name: 'TicketTime3',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '开票时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'TicketMoney3', name: 'TicketMoney3', maxLength: 50,
                                                        emptyText: '', width: 90, minValue: 0, maxValue: 999999999, enableKeyEvents: true, listeners: {
                                                            'keyup': function (e) {
                                                                TotalInvoiceValueHas();
                                                            }
                                        ...
                                        },
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'TicketTime4', name: 'TicketTime4',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '开票时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'TicketMoney4', name: 'TicketMoney4', maxLength: 50,
                                                        emptyText: '', width: 90, minValue: 0, maxValue: 999999999, enableKeyEvents: true, listeners: {
                                                            'keyup': function (e) {
                                                                TotalInvoiceValueHas();
                                                            }
                                        ...
                                        },
                                        {
                                            ...
                                            msgTarget: 'under',
                                            items: [
                                                   { fieldLabel: '付款日期', xtype: 'datefield', id: 'TicketTime5', name: 'TicketTime5',
                                                       emptyText: '', format: 'Y-m-d', anchor: '100%', emptyText: '开票时间'
                                                   },
                                                    { fieldLabel: '付款金额', xtype: 'numberfield', id: 'TicketMoney5', name: 'TicketMoney5', maxLength: 50,
                                                        emptyText: '', width: 90, minValue: 0, maxValue: 999999999, decimalPrecision: 2,
                                                        allowDecimals: true, emptyText: '付款金额', enableKeyEvents: true, listeners: {
                                                            'keyup': function (e) {
                                                                TotalInvoiceValueHas();
                                                            }
                                                        }
                   ...
                   items: [
                     {
                         ...
                         layout: "form", // 从上往下的布局
                         items: [
                         { fieldLabel: '经费名称', xtype: 'textfield', id: 'ContraceName', name: 'ContraceName', maxLength: 50,
                             maxLengthText: '经费名称长度不能超过50个字符', anchor: '90%'
                         }
                             ]
                     },
                       {
                   ...
                   items: [
                     {
                         ...
                         items: [
                         {
                             ...
                             items: [
                                      ...
                                      { fieldLabel: '待付金额', xtype: 'numberfield', id: 'BegReceivablesAmount', name: 'BegReceivablesAmount', maxLength: 50,
...
function GetParam() {
    if (top.Ext.getCmp("SearchPanel")) {
        var Nature = top.Ext.getCmp("NatureName").getValue(); //经费性质
        var Project = top.Ext.getCmp("ProjectName").getValue(); //项目
        var ProjectPhase = top.Ext.getCmp("ProjectPhaseName").getValue(); //经费阶段
        var ContractState = top.Ext.getCmp("ContractStateName").getValue(); //经费状态
        ...
        param = {
            ...
            ContraceName: top.Ext.getCmp("ContraceName").getValue().trim(), //经费名称
            ...
            ContractIimplementation: top.Ext.getCmp("ContractIimplementation").getValue().trim(), //经费执行情况
            ...
            Currency: top.Ext.getCmp("Currency").getValue().trim(), //经费金额币种
            TaxRate: top.Ext.getCmp("TaxRate").getValue().trim(), //发票税率
            UnitName: top.Ext.getCmp("UnitName").getValue().trim(), //协作单位名
            BegTotalContractAmount: top.Ext.getCmp("BegTotalContractAmount").getValue(), //经费总金额
            EndTotalContractAmount: top.Ext.getCmp("EndTotalContractAmount").getValue(), //
            BenReceiptsTotalAmount: top.Ext.getCmp("BenReceiptsTotalAmount").getValue(), //财务支付总额
            EndReceiptsTotalAmount: top.Ext.getCmp("EndReceiptsTotalAmount").getValue(), //
            BegReceivablesAmount: top.Ext.getCmp("BegReceivablesAmount").getValue(), //待付金额
