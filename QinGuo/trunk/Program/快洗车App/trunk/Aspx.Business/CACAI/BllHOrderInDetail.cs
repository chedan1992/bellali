...
{
    public class BllHOrderInDetail : BllBase<ModHOrderInDetail>
    {
        private IHOrderInDetail DAL = CreateDalFactory.CreateHOrderInDetail();
        ...
        {
            search.TableName = @"H_OrderInDetail"; //表名
