 ...
 <!--引用fileUpLoad-->
    ...
    <script language="javascript" type="text/javascript">
        Ext.onReady(function () {
            ...
            //下载路径
            var downMoBanUlr = "/Project/Template/供应商模板.xlsx";
                ...
                items: [
                        {
                            ...
                            items: [
...

                              {
                                  ...
                                  html: '1 请按照模板要求进行填写，否则导入会不成功。<br/>'
                                         + '2 供应商内部编号，供应商名，编码，分类不能为空。<br/>'
                                         + '3 供应商状不填态默认为启用。<br/>'
                                         + '4 结账方式分为 月结或者日结，或者不填。<br/>'
                                         + '5 付款方式分为 支付宝，工行，农行，或者不填。<br/>'
                              ...
                              },
                            {
                                ...
                                id: 'downerror',
                                fieldLabel: '信息提示',
                                style: 'padding-left:5px;padding-top:3px;color:blue',
                                xtype: 'panel',
                                width: 300,
                                anchor: '90%',
                                hidden: true,
        ...
        function SaveDate() {
            ...
            if (formPanel.getForm().isValid()) {//如果验证通过
                formPanel.getForm().submit({
                    ...
                    url: '/CACAI/Export/ImportDate?CType=1', //记录表单提交的路径
                    method: "POST",
