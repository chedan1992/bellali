...
<asp:Content ID="Content2" ContentPlaceHolderID="UrlContent" runat="server">
    ...
    <script src="<%=Url.Content("~/Areas/CACAI/Project/PayBill/PayBill.js?version=1.5") %>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Areas/CACAI/Project/PayBill/PayBillLayout.js?version=1.5") %>" type="text/javascript"></script>
