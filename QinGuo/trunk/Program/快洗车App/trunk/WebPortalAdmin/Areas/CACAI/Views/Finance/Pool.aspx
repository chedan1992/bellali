...
<asp:Content ID="Content2" ContentPlaceHolderID="UrlContent" runat="server">
    ...
    <script src="<%=Url.Content("~/Areas/CACAI/Project/Pool/Pool.js?version=1.5") %>" type="text/javascript"></script>
    <script src="<%=Url.Content("~/Areas/CACAI/Project/Pool/PoolLayout.js?version=1.5") %>" type="text/javascript"></script>
