...
Ext.onReady(function () {
    ...
    var store = GridStore(Member, '/CACAI/HPurchase/SearchData', className, 'FinancialState', 'asc');
...
//                 menuDisabled: true,
//                 renderer: function (value, meta, record, rowIdx, colIdx, store) {
//                     var content = '<div><span style="vertical-align: middle;cursor:pointer" title="上传凭证" onclick="uploadFile();"><img style="vertical-align: middle; width:18px; height:18px;border:0" class="GTP_upload"  src="../../Content/Extjs/resources/images/default/s.gif"/></span></div>';
//                     return content;
//                 }
//             },
    ...
    grid.store.on('beforeload', function (node) {
        ...
        grid.getStore().proxy.conn.url = '/CACAI/HPurchase/SearchData?' + search;
    });
