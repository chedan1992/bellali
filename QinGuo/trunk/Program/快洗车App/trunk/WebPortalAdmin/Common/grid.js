...
//auto:是否自动加载
//loadFun：
function GridStore(ReaderModel, url, className, SortField, direction, auto,loadFun) {
    var autoLoad = true;
    if (auto == false) {
        autoLoad = false;
    }
...
function bbar(store, gridId, className) {
    var comboxshow = new Ext.form.ComboBox({
        store: new Ext.data.SimpleStore({
            fields: ['text', 'value'],
            data: [['15', '15'], ['20', '20'], ['30', '30'], ['40', '40'], ['60', '60'], ['80', '80'], ['150', '150'], ['200', '200'], ['500', '500'], ['1000', '1000']]
        }),
        displayField: 'text',
        valueField: 'value',
        mode: 'local',
...
//分页工具条
function DIYbbar(store) {
    var comboxshow = new Ext.form.ComboBox({
        store: new Ext.data.SimpleStore({
            fields: ['text', 'value'],
            data: [['15', '15'], ['20', '20'], ['30', '30'], ['40', '40'], ['60', '60'], ['80', '80'], ['150', '150'], ['200', '200'], ['500', '500']]
        }),
        displayField: 'text',
        valueField: 'value',
        mode: 'local',
...
function ClumnHide(gridId, className) {
    ...
    if (grid) {
        ...
        win.width =450;
        win.height =500;// (270 + (unitColumns.length /3) *16);
        win.show();
    }
}
