...
namespace QINGUO.Factory
{
    public class CreateDalFactory : IDataAccess
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static ISysFileAttach CreateSysFileAttach()
        {
            string className = path + ".SysFileAttachDAL";

            return (ISysFileAttach)Assembly.Load(path).CreateInstance(className);
        }
          /// <summary>
        /// 型号表
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public static IHPurchaseRelation CreateHPurchaseRelation()
        {
            string className = path + ".HPurchaseRelationDAL";
            return (IHPurchaseRelation)Assembly.Load(path).CreateInstance(className);
        }
        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        public static IHOrderInRelation CreateHOrderInRelation()
        {
            string className = path + ".HOrderInRelationDAL";
            return (IHOrderInRelation)Assembly.Load(path).CreateInstance(className);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static IHFinanceDetail CreateHFinanceDetail()
        {
            string className = path + ".HFinanceDetailDAL";
            return (IHFinanceDetail)Assembly.Load(path).CreateInstance(className);
        }
        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        public static IHFinance CreateHFinance()
        {
            string className = path + ".HFinanceDAL";
            return (IHFinance)Assembly.Load(path).CreateInstance(className);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static IShopAttributeExtension CreateShopAttributeExtension()
        {
            string className = path + ".ShopAttributeExtensionDAL";
            return (IShopAttributeExtension)Assembly.Load(path).CreateInstance(className);
        }
                    /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        public static IShopAttributeType CreateShopAttributeType()
        {
            string className = path + ".ShopAttributeTypeDAL";
            return (IShopAttributeType)Assembly.Load(path).CreateInstance(className);
        }
                     /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        public static IHOrderIn CreateHOrderIn()
        {
            string className = path + ".HOrderInDAL";
            return (IHOrderIn)Assembly.Load(path).CreateInstance(className);
        }
                     /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        public static IHOrderInDetail CreateHOrderInDetail()
        {
            string className = path + ".HOrderInDetailDAL";
            return (IHOrderInDetail)Assembly.Load(path).CreateInstance(className);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static IHPurchaseDetail CreateHPurchaseDetail()
        {
            string className = path + ".HPurchaseDetailDAL";
            return (IHPurchaseDetail)Assembly.Load(path).CreateInstance(className);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static IHPurchase CreateHPurchase()
        {
            string className = path + ".HPurchaseDAL";
            return (IHPurchase)Assembly.Load(path).CreateInstance(className);
        }
                 /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        public static IShopAttributeExtensionValue CreateShopAttributeExtensionValue()
        {
            string className = path + ".ShopAttributeExtensionValueDAL";
            return (IShopAttributeExtensionValue)Assembly.Load(path).CreateInstance(className);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static IContractInOut CreateContractInOut()
        {
            string className = path + ".ContractInOutDAL";
            return (IContractInOut)Assembly.Load(path).CreateInstance(className);
        }
        ...
        {
            string className = path + ".CarDAL";
            return (ICar)Assembly.Load(path).CreateInstance(className);
        }


        public static ICarEquipment CreateCarEquipment()
        {
            string className = path + ".CarEquipmentDAL";
            return (ICarEquipment)Assembly.Load(path).CreateInstance(className);
        }

        public static ICarOrder CreateCarOrder()
        {
            string className = path + ".CarOrderDAL";
            return (ICarOrder)Assembly.Load(path).CreateInstance(className);
        }
        public static ICarProject CreateCarProject()
        {
            string className = path + ".CarProjectDAL";
            return (ICarProject)Assembly.Load(path).CreateInstance(className);
        }

        public static IWashCar CreateWashCar()
        {
            string className = path + ".WashCarDAL";
            return (IWashCar)Assembly.Load(path).CreateInstance(className);
        }

        public static ICarUser CreateCarUser()
        {
            string className = path + ".CarUserDAL";
            return (ICarUser)Assembly.Load(path).CreateInstance(className);
        }

        public static IWashCarRecord CreateWashCarRecord()
        {
            string className = path + ".WashCarRecordDAL";
            return (IWashCarRecord)Assembly.Load(path).CreateInstance(className);
        }
