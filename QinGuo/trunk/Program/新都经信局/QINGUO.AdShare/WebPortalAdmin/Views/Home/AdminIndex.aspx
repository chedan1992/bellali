...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="center" class="mainbox x-hide-display">
        <div class="mainleft">
            ...
            <div class="leftinfos">
                ...
                <div class="inforight">
                    <div class="listtitle">
                        <a href="#" class="more1"></a>展示位</div>
                         <div id="chartPart" class="maintj" style="width: 100%; height: 100%">
                        </div>
                   <%-- <ul class="tooli">
                        <li><span>
                            <img src="Resource/img/Index/d01.png" /></span><p>
                                <a href="#">信息资料</a></p>
                        </li>
                    </ul>--%>
                </div>
        ...
        <div class="mainright">
            ...
            <div class="dflist1">
                <div class="listtitle">
                    <a href="#" class="more1"></a>系统统计</div>
                <ul class="newlist">
                    <li><i>系统用户：</i><%=ViewData["UserCount"]%>&nbsp;</li>
                 <%--   <li><i>使用单位：</i><%=ViewData["CompanyCount"]%>&nbsp;</li>
                    <li><i>设备总量：</i><%=ViewData["EventCount"]%>&nbsp;</li>
                    <li><i>过期设备：</i><%=ViewData["LostEvent"]%></li>
                    <li><i>超期未检：</i><%=ViewData["LostTime"]%></li>--%>
                </ul>
            </div>
        </div>
        <!--mainright end-->
