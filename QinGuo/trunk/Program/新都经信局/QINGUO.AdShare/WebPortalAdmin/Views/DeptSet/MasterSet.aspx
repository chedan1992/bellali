...
<asp:Content ID="Content2" ContentPlaceHolderID="UrlContent" runat="server">
  <!--文件区域-->
    ...
    <script src="../../Project/MasterSet/MasterSetLayout.js?version=1.5" type="text/javascript"></script>
    <script src="../../Project/MasterSet/MasterSet.js?version=1.5" type="text/javascript"></script>
    <%--引入地图--%>
